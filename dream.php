...
<body>
        ...
        <div class="top-bar">
            ...
            <div class="user-info">
                ...
                <div>
                    ...
                    <div id="user-department">Please login</div>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="demo-credentials">
                    ...
                    <div class="credential-item">
                        <strong>Student:</strong> student@example.com / dream123
                    </div>
                    <div class="credential-item">
                        <strong>Librarian:</strong> librarian@example.com / dream123
                    </div>
                    <div class="credential-item">
                        <strong>Admin:</strong> admin@example.com / dream123
                    </div>
                </div>
                ...
                <form id="register-form">
                    ...
                    <div class="form-group">
                        ...
                        <select id="reg-department" class="form-control" required>
                            <option value="">Select Department</option>
                            <option value="Computer Science">BSC Pharmacy</option>
                            <option value="Mathematics">BSC Nurse</option>
                            <option value="Physics">Pharmacy Technology</option>
                            <option value="Chemistry">Laburatory Technology</option>
                            <option value="Biology">Accounting</option>
                            <option value="Literature">Management</option>
    ...
    <script>
        ...
        // Fixed sample users with consistent passwords
        const sampleUsers = [
            {
                id: 0271/15,
                name: "Tilahun Tadesse",
                email: "tile123@gmail.com",
                password: "dream123", // Added password field
                role: "student",
                department: "Computer Science",
                age: 23,
                gender: "Male"
            },
            {
                id: 0259/15,
                name: "Mohammed Seid",
                email: "mame123@gmail.com",
                password: "dream123", // Added password field
                role: "Student",
                department: "Computer scinces",
                age: 28,
                gender: "Male"
            },
            {
        ...
        function handleLogin(e) {
            ...
            if (user && user.password === password) {
                ...
                alert('Invalid credentials. Please try again.\n\nUse the demo credentials provided below the form.');
            }
        }
        ...
        function handleRegister(e) {
            ...
            // Show success message
            alert('Registration successful! You are now logged in as a student.');
        }
        ...
        function updateUIForUser() {
            if (currentUser) {
                ...
                userDepartmentSpan.textContent = 'Please login';
